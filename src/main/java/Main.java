...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            System.out.println("Program for calculating trip duration of the St. Petersburg metro\nFor exit enter \"0\"\n");
            Station from = takeStation("Enter departure station:");
            Station to = takeStation("Enter destination station:");
        ...
        for (Station station : route) {
            if (previousStation != null) {
                ...
                if (!prevLine.equals(nextLine)) {
                    System.out.println("\tTransfer to station " +
